...
function draw_beat()
    ...
    local x, y = calculate_electron_x_y(#current_element.shells, 360, current_beat)
...
function draw_atom()
    ...
    local text_width = fonts.atom_symbol:getWidth(current_element.symbol)
    local text_height = fonts.atom_symbol:getHeight()
    love.graphics.print(current_element.symbol, nucleus_center_x - text_width / 2, nucleus_center_y - text_height / 2)
end
